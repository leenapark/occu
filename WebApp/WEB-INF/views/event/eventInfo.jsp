								...
								function copy_url(val){
									...
									<div style="width: 80%; margin: 0 auto; text-align: center; padding: 20px;">
										...
										<img class="form_profile_img" src="${formData.formPath}" style="cursor: pointer;" onclick="location.href='/p/u4OFCypbqz';"> <span
											style="display: block; font-weight: 700; font-size: 16px; padding: 10px; color: #373737; cursor: pointer;"
											onclick="location.href='/p/u4OFCypbqz';">판매자 </span>
										<div style="display: block;">
											<a href="https://twitter.com/addict_jd" target="_blank"><img src="//d2i2w6ttft7yxi.cloudfront.net/site_img/image/twitter_gray.png"
...
.seller_business_info {
	...
	color: #bcbcbc;
						...
						<form id="deposit_form" enctype="multipart/form-data" method="POST" action="deposit_form_goods_process.php">
							<input type="hidden" name="form_log_check" value=""> <input type="hidden" name="form_idx" value="452888"> <input type="hidden"
								name="user_idx" value="7598">
...
.the_cheat img {
	...
	margin-bottom: 1px;
								...
								<div class="col-md-12" style="font-size: 15px; text-align: left;">
									<span class="the_cheat" style="margin-bottom: 10px; padding-left: 15px; padding-right: 15px;">· 판매자의 입금처 정보는 입금폼을 제출한 <strong>다음
											화면</strong>에서 확인하실 수 있습니다.<br>· 윗치폼 회원인 경우 <strong>폼 참여 내역</strong>에서 입금처 정보를 확인하실수 있습니다.
									</span><br>
								</div>
							</div>
							<div class="row" style="padding-top: 5px;">
							...
							<div class="row">
								...
								<div class="col-lg-6">
									...
									<div class="form-group">
										<input class="form-control" type="hidden" min="0" inputmode="numeric" pattern="[0-9]*" id="buyer_price" name="buyer_price" value=""
											placeholder="입금액(숫자만 입력하세요)">
									</div>
								</div>
							</div>
							...
							<div class="row">
								<div class="col-md-12" style="font-size: 15px;">
									<div
										...
										상품 주문 및 배송을 위해 위에 입력된 개인정보를 수집합니다. 수집한 개인정보는<br> 주문과 배송이외의 목적으로는 사용하지 않습니다.<br> 개인정보의 수집 및 이용에 대한 동의를 거부할수 있으며, 이 경우 상품 주문이 어려울 수
										있습니다.
									</div>
								...
								<div class="content">
									<div class="content_main" style="padding: 0 15px;">
										...
										<div id="submit_btn" class="content_item"
											...
											>>>>>>> branch 'pln' of https://github.com/leenapark/occu.git
										</div>
									</div>
								</div>
							</div>
