		...
		<c:forEach items="${postList}" var="post">
			<div class="post_list">
				...
				<div class="profile_img p-0">
					<a class="" href="${pageContext.request.contextPath}/profile"> <!-- profile --> <img
						src="${pageContext.request.contextPath}/assets/images/profile/${post.profileImg}" alt="profile image">
					</a>
				</div>
