	...
	<div id="wrap">
		...
		<div class="form-area">
			...
			<div class="messageBox">
				...
				<form action="${pageContext.request.contextPath}/dm/upload_ok" method="post" enctype="multipart/form-data">
					파일 선택 : <input type="file" name="file"> <input type="submit" value="전송">
				</form>
				...
				<!-- 파일 두개이상 붙히는거 -->
				<form action="${pageContext.request.contextPath}/dm/upload_ok2" method="post" enctype="multipart/form-data">
					파일 선택 : <input type="file" multiple="multiple" name="files"> <input type="submit" value="전송">
				</form>
